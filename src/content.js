...
export const solutionPages = [
  {
    ...
    seoTitle: "AI real estate operations та автоматизація | AI Insider",
    description:
  ...
  },
  {
    ...
    seoTitle: "Автоматизація салону краси та KPI | AI Insider",
    description:
  ...
  },
  {
    ...
    kicker: "AGENCY SALES · PROPOSALS",
    title: "AI proposal generator для агенцій",
    seoTitle: "AI proposal generator for agencies | AI Insider",
    description:
      "AI proposal generator для агенцій: збирає дані з CRM, формує scope, кошторис і комерційну пропозицію та передає її менеджеру на перевірку.",
    dek: "Запит клієнта перетворюється на структурований draft пропозиції: контекст, scope, етапи, припущення й наступний крок — без ручного складання документа з нуля.",
    problem:
      "Менеджер копіює нотатки з дзвінка, шукає старий шаблон, узгоджує scope і переписує однакові блоки. Пропозиція виходить повільно, а важливі обмеження губляться між CRM і документом.",
    flow: [
      "CRM, brief або transcript дзвінка",
      "Структурування потреб і ризиків",
      "Scope, етапи та розрахунок",
      "Human review і затвердження",
      "PDF, CRM status і follow-up",
    ],
    outcomes: [
      "швидший first draft",
      "єдиний стандарт пропозицій",
      "видимі припущення й approval",
    ],
    integrations: [
      "HubSpot / Pipedrive",
      "Google Docs",
    ...
    faq: [
      [
        "Чи може AI сам визначати ціну?",
        "Модель може підготувати розрахунок за затвердженими правилами, але нестандартний scope, знижки й фінальну ціну підтверджує відповідальна людина.",
      ],
      [
        "Чи потрібна CRM?",
        "Ні. Перший прототип може працювати з формою, transcript і шаблоном документа. CRM додаємо, коли потрібно автоматично вести статус і follow-up.",
      ],
    ],
  },
  {
    slug: "ai-email-automation",
    kicker: "EMAIL OPERATIONS",
    title: "AI-автоматизація email для бізнесу",
    seoTitle: "AI email automation для бізнесу | AI Insider",
    description:
      "AI email automation: класифікація листів, витяг даних, draft відповіді, створення задачі та контроль SLA з обов’язковою ескалацією людині.",
    dek: "Вхідний лист стає контрольованою дією: система визначає намір, знаходить потрібний контекст, готує відповідь або задачу й не приховує винятки від команди.",
    problem:
      "Спільна пошта змішує заявки, підтримку, документи й внутрішні запити. Листи пересилаються вручну, власник відповіді незрозумілий, а SLA неможливо перевірити.",
    flow: [
      "Новий лист і вкладення",
      "Класифікація та витяг полів",
      "Пошук контексту й policy check",
      "Draft, задача або ескалація",
      "Відповідь, CRM і audit trail",
    ],
    outcomes: [
      "менше ручного сортування",
      "швидша підготовка відповіді",
      "контроль SLA та винятків",
    ],
    integrations: [
      "Gmail / Outlook",
      "CRM",
    ...
    faq: [
      [
        "Чи надсилає система відповіді без людини?",
        "Лише для дозволених низькоризикових сценаріїв. Ціни, договори, скарги й нестандартні запити проходять human approval.",
      ],
      [
        "Як система працює з вкладеннями?",
        "Файли проходять перевірку типу й розміру, після чого дозволені дані витягуються у структуровані поля з посиланням на джерело.",
      ],
    ],
  },
  {
    slug: "ai-company-knowledge-search",
    kicker: "KNOWLEDGE · RAG",
    title: "AI-пошук у базі знань компанії",
    seoTitle: "AI search assistant for company knowledge | AI Insider",
    description:
      "AI search assistant для бази знань компанії: пошук у документах, відповіді з цитатами, права доступу, контроль актуальності та передача людині.",
    dek: "Співробітник ставить питання звичайною мовою й отримує коротку відповідь з посиланнями на конкретні документи — у межах своїх прав доступу.",
    problem:
    ...
    flow: [
      "Джерела та права доступу",
      "Очищення й версіонування знань",
      "Пошук релевантних фрагментів",
      "Відповідь із цитатами",
      "Feedback, gaps і оновлення",
    ],
    outcomes: [
      "менше часу на пошук",
